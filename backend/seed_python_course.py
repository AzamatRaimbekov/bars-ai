        ...
        "lessons": [
            {
                ...
                "xp": 20,
                "steps": [
                    {"type": "video", "title": "Python для начинающих — print и переменные", "url": "https://www.youtube.com/watch?v=vMPrzqEUMzY"},
            ...
            },
            {
                ...
                "xp": 15,
                "steps": [
                    {"type": "video", "title": "Python за 1 час — основы", "url": "https://www.youtube.com/watch?v=jtrJt1s8jKo"},
            ...
            },
            {
                ...
                "xp": 20,
                "steps": [
                    {"type": "video", "title": "Python для начинающих — полный курс", "url": "https://www.youtube.com/watch?v=KdZ4HF1SrGs"},
        ...
        "lessons": [
            {
                ...
                "xp": 25,
                "steps": [
                    {"type": "video", "title": "Типы данных Python", "url": "https://www.youtube.com/watch?v=_TVmdiYiTzk"},
            ...
            },
            {
                ...
                "xp": 25,
                "steps": [
                    {"type": "video", "title": "Строки в Python", "url": "https://www.youtube.com/watch?v=JjPSjOK4LyQ"},
        ...
        "lessons": [
            {
                ...
                "xp": 25,
                "steps": [
                    {"type": "video", "title": "Условия if/else Python", "url": "https://www.youtube.com/watch?v=GfMXH7HjPGA"},
        ...
        "lessons": [
            {
                ...
                "xp": 30,
                "steps": [
                    {"type": "video", "title": "Циклы for и while Python", "url": "https://www.youtube.com/watch?v=cKINzwVl87A"},
        ...
        "lessons": [
            {
                ...
                "xp": 30,
                "steps": [
                    {"type": "video", "title": "Списки Python", "url": "https://www.youtube.com/watch?v=owxJz4KHDQU"},
        ...
        "lessons": [
            {
                ...
                "xp": 30,
                "steps": [
                    {"type": "video", "title": "Функции Python", "url": "https://www.youtube.com/watch?v=Smi0RI4bSRw"},
        ...
        "lessons": [
            {
                ...
                "xp": 30,
                "steps": [
                    {"type": "video", "title": "Словари Python", "url": "https://www.youtube.com/watch?v=PiC4G0g5diQ"},
    ...
    # ==================== SECTION 8: Работа с файлами и модулями ====================
    {
        ...
        "lessons": [
            ...
            },
            {
                ...
                "xp": 50,
                "steps": [
                    {"type": "video", "title": "Python за 1 час — программирование для начинающих", "url": "https://www.youtube.com/watch?v=jtrJt1s8jKo"},
