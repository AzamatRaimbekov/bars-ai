...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Проходи уроки, набирай звёзды за каждое задание, поднимайся в рейтинге спринта. Топ-3 участника получают денежные призы в тенге. Спринты проходят регулярно.',
  },
  {
